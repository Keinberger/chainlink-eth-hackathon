...
module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    const contractConfig = networkConfig[chainId].contracts.PriceOracle
    constructorArguments = [contractConfig.args.usdcAddress, contractConfig.args.newAggregators]
...
module.exports.tags = ["all", "PriceOracle"]
