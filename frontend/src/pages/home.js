        ...
        <Container>
            ...
            <Section2>
                <Section2Left>
                    ...
                    <BelowNumbers>
                        Variable APY from top USD lending markets in the blockchain.
                    </BelowNumbers>
                </Section2Left>
                ...
                <Section2Right>
                    ...
                    <Description>
                        2. Fund your wallet with a credit/debit card or bank transfer
                    </Description>
            ...
            <Section3>
                <Section3Left>
                    ...
                    <UpperCard>
                        ...
                        <TextArea>
                            <Title>AAVE</Title>
                            <Description>
                                A top DeFi platform that lends to over-collateralized borrowers
                            </Description>
                        </TextArea>
                    </UpperCard>
                    ...
                    <UpperCard>
                        ...
                        <TextArea>
                            <Title>DAI </Title>
                            <Description>
                                A digital currency (equal to 1 USD) backed by locked crypto
                                collateral
                            </Description>
                        </TextArea>
                    </UpperCard>
                    ...
                    <UpperCard>
                        ...
                        <TextArea>
                            <Title>USDC</Title>
                            <Description>
                                A digital currency (equal to 1 USD) backed by locked USD collateral.
                            </Description>
                        </TextArea>
                    </UpperCard>
                </Section3Left>
                <Section3Right>
                    <Title>Risk</Title>
                    <Description>
                        Interest rates never go below zero. However, you could lose your initial
                        deposit if:
                    </Description>
                    <br></br>
                    <Description>
                        The USD lending market is hacked<br></br>The USD blockchain currency loses
                        its value or is hacked
                    </Description>
                </Section3Right>
            </Section3>
            <ButtonContainer>
